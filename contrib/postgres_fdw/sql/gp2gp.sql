...
-- ===================================================================
-- test partial distributed table
-- ===================================================================
create extension if not exists gp_debug_numsegments;
-- Create a hash table distributed on 2 segments
...
CREATE FOREIGN TABLE ft3 (
	...
	c5 timestamp,
	c6 varchar(10),
	c7 char(10) default 'ft3',
	c8 user_enum
) SERVER loopback OPTIONS(schema_name 'public', table_name 't3');

-- single table, with/without alias
EXPLAIN (COSTS false) SELECT * FROM ft3 ORDER BY c3, c1 OFFSET 100 LIMIT 10;
SELECT * FROM ft3 ORDER BY c3, c1 OFFSET 100 LIMIT 10;
EXPLAIN (VERBOSE, COSTS false) SELECT * FROM ft3 t1 ORDER BY t1.c3, t1.c1 OFFSET 100 LIMIT 10;
SELECT * FROM ft3 t1 ORDER BY t1.c3, t1.c1 OFFSET 100 LIMIT 10;
-- whole-row reference
EXPLAIN (VERBOSE, COSTS false) SELECT t1 FROM ft3 t1 ORDER BY t1.c3, t1.c1 OFFSET 100 LIMIT 10;
SELECT t1 FROM ft3 t1 ORDER BY t1.c3, t1.c1 OFFSET 100 LIMIT 10;
-- empty result
SELECT * FROM ft3 WHERE false;
-- with WHERE clause
EXPLAIN (VERBOSE, COSTS false) SELECT * FROM ft3 t1 WHERE t1.c1 = 101 AND t1.c6 = '1' AND t1.c7 >= '1';
SELECT * FROM ft3 t1 WHERE t1.c1 = 101 AND t1.c6 = '1' AND t1.c7 >= '1';
-- aggregate
SELECT COUNT(*) FROM ft3 t1;
-- join two tables
SELECT t1.c1 FROM ft3 t1 JOIN ft3 t2 ON (t1.c1 = t2.c1) ORDER BY t1.c3, t1.c1 OFFSET 100 LIMIT 10;
-- subquery
SELECT * FROM ft3 t1 WHERE t1.c3 IN (SELECT c3 FROM ft3 t2 WHERE c1 <= 10) ORDER BY c1;
-- subquery+MAX
SELECT * FROM ft3 t1 WHERE t1.c3 = (SELECT MAX(c3) FROM ft3 t2) ORDER BY c1;
-- used in CTE
WITH t1 AS (SELECT * FROM ft3 WHERE c1 <= 10) SELECT t2.c1, t2.c2, t2.c3, t2.c4 FROM t1, ft3 t2 WHERE t1.c1 = t2.c1 ORDER BY t1.c1;
-- fixed values
SELECT 'fixed', NULL FROM ft3 t1 WHERE c1 = 1;
