...
/* gp_endpoints(OUT dbid int4, OUT auth_token text, OUT cursorname text, OUT sessionid int4, OUT hostname text, OUT port int4, OUT userid oid, OUT state text, OUT endpointname text) => SETOF record */
...
/* gp_wait_parallel_retrieve_cursor(text, int4) => bool */
DATA(insert OID = 6174 ( gp_wait_parallel_retrieve_cursor  PGNSP PGUID 12 1 0 0 0 f f f f f f v 2 0 16 "25 23" _null_ _null_ _null_ _null_ gp_wait_parallel_retrieve_cursor _null_ _null_ _null_ n a ));
