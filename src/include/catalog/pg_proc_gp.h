...
DATA(insert OID = 6174 ( gp_wait_parallel_retrieve_cursor  PGNSP PGUID 12 1 0 0 0 f f f f f f v 2 0 16 "25 23" "{25,23,16}" "{i,i,o}" "{cursorname,timeout_sec,finished}" _null_ gp_wait_parallel_retrieve_cursor _null_ _null_ _null_ n a ));
